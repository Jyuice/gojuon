window.onload = function() {
    class Home {
        ...
        start() {
            ...
            setTimeout(() => {
                ...
                home = null
                // 漣漪動畫，傳秒數和難度進去(難度折算成getUI的指標)
                new ripple(3, self.getUI())
            }, 500)
            img = null
            main = null
        }
    ...
    // 漣漪動畫
    class ripple {
        constructor(second = 3, difficulty) {
    ...
    class Game {
        constructor(difficulty) {
            this.difficulty = difficulty // 這裏的difficulty表示最多可以考到名爲difficulty的map
            this.score = 0 // 一共正確了多少個
            this.live = 10 // 剩餘可錯誤的次數
            this.wrong = [] // 收集打錯的以便最後展示復習
            this.start()
        }
