window.onload = function() {
    ...
    var game_page = document.getElementById('game-page')
    var img = document.getElementById('home-img')
    var main = document.getElementById('main')
    var btn = document.getElementById('btn')
    var ready_page = document.getElementById('ready-page')
    ...
    class Game extends Home {
        ...
        start() {
            ...
            this.firstSecond()
            // 隨機時間產生元素
            this.timer = setInterval(this.firstSecond, this.getRandom(1, this.int) * 1000)
        }
