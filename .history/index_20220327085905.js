window.onload = function() {
    ...
    class Game extends Home {
        ...
        start() {
            ...
            let timer = setInterval(() => {
                ...
                const { left, speed, value } = this.culculate()
                node.style.cssText += `
                    left: ${left}px;
    ...
    // 打字事件
    window.addEventListener('keydown', e => g.handle(e))
    window.removeEventListener('keydown', e => g.handle(e))
