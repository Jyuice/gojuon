window.onload = function() {
    ...
    // ready-page
    const ready_page = document.getElementById('ready-page')
    ...
    const score_show = document.getElementById('score-show')
    const score_text = document.getElementById('score-text')
    const score_btn = document.getElementById('score-btn')
    const score_contain = document.getElementById('score-contain')
    const score = score_contain.firstElementChild
    const live = score_contain.lastElementChild
